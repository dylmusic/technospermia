...
<ConceptDiagram nodes={[{id: "a", label: "Psychedelic / Ketamine"}, {id: "b", label: "5-HT2A agonism (psychedelics) / NMDA antagonism (ketamine)"}, {id: "c", label: "BDNF release"}, {id: "d", label: "TrkB receptor activation"}, {id: "e", label: "Dendritic spine growth"}, {id: "f", label: "Synaptogenesis"}, {id: "g", label: "Neuroplasticity window opens"}, {id: "h", label: "Integration — therapy / experience / behavior"}, {id: "i", label: "New pattern consolidates"}, {id: "j", label: "Window closes"}]} connections={[{from: "a", to: "b", label: "triggers"}, {from: "b", to: "c", label: "induces"}, {from: "c", to: "d", label: "binds"}, {from: "d", to: "e", label: "drives"}, {from: "e", to: "f", label: "enables"}, {from: "f", to: "g", label: "opens"}, {from: "g", to: "h", label: "during"}, {from: "h", to: "i", label: "leads to"}, {from: "i", to: "j", label: "then"}]} />
