...
<ConceptDiagram
  nodes={[
    { id: "ketamine", label: "Ketamine infusion" },
    { id: "nmda", label: "NMDA receptor blockade" },
    { id: "disinhibit", label: "Glutamate activity shifts to AMPA receptors" },
    { id: "bdnf", label: "BDNF released from neurons" },
    { id: "trkb", label: "TrkB receptor activation" },
    { id: "spine", label: "Rapid dendritic spine growth" },
    { id: "synapse", label: "Synaptogenesis in prefrontal cortex" },
    { id: "effect", label: "Restored synaptic connectivity — antidepressant effect" }
  ]}
  connections={[
    { from: "ketamine", to: "nmda", label: "open-channel block" },
    { from: "nmda", to: "disinhibit", label: "NMDA blocked → AMPA activated" },
    { from: "disinhibit", to: "bdnf", label: "AMPA signaling triggers BDNF" },
    { from: "bdnf", to: "trkb", label: "binds receptor" },
    { from: "trkb", to: "spine", label: "downstream signaling" },
    { from: "spine", to: "synapse", label: "new connections form" },
    { from: "synapse", to: "effect", label: "prefrontal function restored" }
  ]}
/>
