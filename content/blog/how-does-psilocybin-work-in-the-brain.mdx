...
<ConceptDiagram
  nodes={[
    { label: "Psilocybin (ingested)" },
    { label: "Alkaline phosphatase (gut/blood)" },
    { label: "Psilocin (active)" },
    { label: "5-HT2A agonism (cortex)" },
    { label: "DMN suppression + entropy increase" },
    { label: "BDNF release" },
    { label: "Neuroplasticity window (2-4 weeks)" },
    { label: "Integration -> lasting change" }
  ]}
  connections={[
    { from: 0, to: 1 },
    { from: 1, to: 2 },
