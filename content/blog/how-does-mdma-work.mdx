...
<ConceptDiagram
  nodes={[
    { label: "MDMA enters neuron" },
    { label: "SERT/DAT/NET reversal" },
    { label: "Massive serotonin + dopamine + NE release" },
    { label: "Amygdala fear response suppressed" },
    { label: "Oxytocin release from hypothalamus" },
    { label: "Empathogenic state + reduced threat perception" },
    { label: "Therapeutic window for trauma processing" }
  ]}
  connections={[
    { from: 0, to: 1 },
    { from: 1, to: 2 },
