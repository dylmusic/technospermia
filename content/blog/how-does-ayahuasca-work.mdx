...
<ConceptDiagram
  nodes={[
    { id: "caapi", label: "B. caapi vine\n(harmine / harmaline / THH)" },
    { id: "mao", label: "MAO-A inhibition\nin gut and liver" },
    { id: "viridis", label: "P. viridis leaves\n(DMT)" },
    { id: "absorb", label: "DMT survives digestion\n→ enters bloodstream" },
    { id: "bbb", label: "Blood-brain barrier\ncrossing" },
    { id: "receptor", label: "5-HT2A + sigma-1\nreceptor binding" },
    { id: "experience", label: "4–6 hour\nayahuasca experience" }
  ]}
  connections={[
    { from: "caapi", to: "mao", label: "harmine/harmaline block MAO" },
    { from: "mao", to: "absorb", label: "DMT no longer destroyed" },
    { from: "viridis", to: "absorb", label: "DMT source" },
    { from: "absorb", to: "bbb", label: "systemic circulation" },
    { from: "bbb", to: "receptor", label: "central nervous system entry" },
    { from: "receptor", to: "experience", label: "sustained activation" }
  ]}
/>
