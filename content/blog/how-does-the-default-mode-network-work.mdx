...
<ConceptDiagram
  nodes={[
    { label: "Medial Prefrontal Cortex (self-evaluation)" },
    { label: "Posterior Cingulate Cortex (autobiographical memory)" },
    { label: "Angular Gyrus (social cognition)" },
    { label: "Hippocampal Formation (memory retrieval)" },
    { label: "Mutual Connectivity" },
    { label: "Self-Narrative Construction" },
    { label: "Temporal Integration (past & future)" },
    { label: "Continuous Sense of Self" }
  ]}
  connections={[
    { from: 0, to: 4 },
    { from: 1, to: 4 },
