...
<ConceptDiagram
  nodes={[
    { label: "LSD molecule (microgram scale)" },
    { label: "5-HT2A receptor binding" },
    { label: "Extracellular loop closes (lid mechanism)" },
    { label: "Beta-arrestin recruitment" },
    { label: "Receptor internalized with LSD inside" },
    { label: "Prolonged intracellular signaling" },
    { label: "8-12 hour experience" }
  ]}
  connections={[
    { from: 0, to: 1 },
    { from: 1, to: 2 },
