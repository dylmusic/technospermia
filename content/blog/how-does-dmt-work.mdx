...
<ConceptDiagram
  nodes={[
    { id: "a", label: "DMT" },
    { id: "b", label: "5-HT2A receptor (cortex)" },
    { id: "c", label: "Sigma-1 receptor (ER membrane)" },
    { id: "d", label: "TAAR1 (trace amine system)" },
    { id: "e", label: "Serotonergic cortical effects + DMN suppression" },
    { id: "f", label: "Cellular stress response / neuroprotection / ER signaling" },
    { id: "g", label: "Dopamine/serotonin modulation via TAAR1" },
    { id: "h", label: "Parallel signal cascades" },
    { id: "i", label: "Entity encounter phenomenology + protective cellular effects" }
  ]}
  connections={[
    { from: "a", to: "b", label: "full agonist" },
    { from: "a", to: "c", label: "agonist" },
    { from: "a", to: "d", label: "agonist" },
    { from: "b", to: "e", label: "produces" },
    { from: "c", to: "f", label: "activates" },
    { from: "d", to: "g", label: "modulates" },
    { from: "e", to: "h", label: "feeds" },
    { from: "f", to: "h", label: "feeds" },
    { from: "g", to: "h", label: "feeds" },
    { from: "h", to: "i", label: "results in" }
  ]}
/>
